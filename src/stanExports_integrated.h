...
namespace model_integrated_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_integrated");
    ...
    reader.add_event(54, 4, "restart", "model_integrated");
    reader.add_event(114, 62, "end", "model_integrated");
    return reader;
}
...
class model_integrated
  : public stan::model::model_base_crtp<model_integrated> {
private:
        int n_obs;
        int n_mis;
        ...
        matrix_d S;
public:
    model_integrated(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_integrated_namespace::model_integrated";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_integrated_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_integrated_namespace::model_integrated stan_model;
#ifndef USING_R
