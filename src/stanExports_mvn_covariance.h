...
namespace model_mvn_covariance_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mvn_covariance");
    ...
    reader.add_event(54, 4, "restart", "model_mvn_covariance");
    reader.add_event(105, 53, "end", "model_mvn_covariance");
    return reader;
}
...
class model_mvn_covariance
  : public stan::model::model_base_crtp<model_mvn_covariance> {
private:
        int n_obs;
        int n_mis;
        ...
        matrix_d Sigma;
public:
    model_mvn_covariance(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mvn_covariance_namespace::model_mvn_covariance";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(multi_normal_log<propto__>(phi, mu, Sigma));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mvn_covariance_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_mvn_covariance_namespace::model_mvn_covariance stan_model;
#ifndef USING_R
