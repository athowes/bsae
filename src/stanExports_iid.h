...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_iid");
    ...
    reader.add_event(54, 4, "restart", "model_iid");
    reader.add_event(102, 50, "end", "model_iid");
    return reader;
}
...
class model_iid
  : public stan::model::model_base_crtp<model_iid> {
private:
        int n_obs;
        int n_mis;
        ...
        vector_d m;
public:
    model_iid(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_iid_namespace::model_iid";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_iid_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_iid_namespace::model_iid stan_model;
#ifndef USING_R
