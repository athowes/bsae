...
namespace model_bym2_morris_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_bym2_morris");
    ...
    reader.add_event(54, 4, "restart", "model_bym2_morris");
    reader.add_event(118, 66, "end", "model_bym2_morris");
    return reader;
}
...
class model_bym2_morris
  : public stan::model::model_base_crtp<model_bym2_morris> {
private:
        int n_obs;
        int n_mis;
...
public:
    model_bym2_morris(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bym2_morris_namespace::model_bym2_morris";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_bym2_morris_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_bym2_morris_namespace::model_bym2_morris stan_model;
#ifndef USING_R
