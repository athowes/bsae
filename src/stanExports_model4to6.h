...
namespace model_model4to6_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model4to6");
    reader.add_event(36, 34, "end", "model_model4to6");
    return reader;
}
#include <stan_meta_header.hpp>
class model_model4to6
  : public stan::model::model_base_crtp<model_model4to6> {
private:
        int n;
        std::vector<int> y;
        std::vector<int> m;
        ...
        matrix_d Sigma;
public:
    model_model4to6(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_model4to6_namespace::model_model4to6";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_model4to6_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_model4to6_namespace::model_model4to6 stan_model;
#ifndef USING_R
