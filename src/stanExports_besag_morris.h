...
namespace model_besag_morris_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_besag_morris");
    ...
    reader.add_event(54, 4, "restart", "model_besag_morris");
    reader.add_event(113, 61, "end", "model_besag_morris");
    return reader;
}
...
class model_besag_morris
  : public stan::model::model_base_crtp<model_besag_morris> {
private:
        int n_obs;
        int n_mis;
...
public:
    model_besag_morris(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_besag_morris_namespace::model_besag_morris";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_besag_morris_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_besag_morris_namespace::model_besag_morris stan_model;
#ifndef USING_R
