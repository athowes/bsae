...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_constant");
    reader.add_event(49, 47, "end", "model_constant");
    return reader;
}
...
class model_constant
  : public stan::model::model_base_crtp<model_constant> {
private:
        int n_obs;
        int n_mis;
...
typedef model_constant_namespace::model_constant stan_model;
#ifndef USING_R
