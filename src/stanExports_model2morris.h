...
namespace model_model2morris_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model2morris");
    reader.add_event(46, 44, "end", "model_model2morris");
    return reader;
}
#include <stan_meta_header.hpp>
class model_model2morris
  : public stan::model::model_base_crtp<model_model2morris> {
private:
        int n;
        std::vector<int> y;
        std::vector<int> m;
...
public:
    model_model2morris(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_model2morris_namespace::model_model2morris";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(phi,multiply(stan::math::sqrt((1 / scaling_factor)), u));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_model2morris_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_model2morris_namespace::model_model2morris stan_model;
#ifndef USING_R
