...
#include "stanExports_bym2_covariance.h"

RCPP_MODULE(stan_fit4bym2_covariance_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_bym2_covariance")
