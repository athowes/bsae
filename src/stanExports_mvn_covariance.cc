...
#include "stanExports_mvn_covariance.h"

RCPP_MODULE(stan_fit4mvn_covariance_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_mvn_covariance")
