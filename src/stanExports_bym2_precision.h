...
namespace model_bym2_precision_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_bym2_precision");
    ...
    reader.add_event(54, 4, "restart", "model_bym2_precision");
    reader.add_event(112, 60, "end", "model_bym2_precision");
    return reader;
}
...
class model_bym2_precision
  : public stan::model::model_base_crtp<model_bym2_precision> {
private:
        int n_obs;
        int n_mis;
        ...
        matrix_d Q;
public:
    model_bym2_precision(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bym2_precision_namespace::model_bym2_precision";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(multi_normal_prec_improper_lpdf<propto__>(u, mu, Q, pstream__));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_bym2_precision_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_bym2_precision_namespace::model_bym2_precision stan_model;
#ifndef USING_R
