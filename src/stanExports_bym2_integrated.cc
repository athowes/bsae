...
#include "stanExports_bym2_integrated.h"

RCPP_MODULE(stan_fit4bym2_integrated_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_bym2_integrated")
