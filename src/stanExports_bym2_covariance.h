...
namespace model_bym2_covariance_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_bym2_covariance");
    ...
    reader.add_event(54, 4, "restart", "model_bym2_covariance");
    reader.add_event(112, 60, "end", "model_bym2_covariance");
    return reader;
}
...
class model_bym2_covariance
  : public stan::model::model_base_crtp<model_bym2_covariance> {
private:
        int n_obs;
        int n_mis;
        ...
        matrix_d Sigma;
public:
    model_bym2_covariance(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bym2_covariance_namespace::model_bym2_covariance";
        ...
        try {
            ...
            validate_non_negative_index("Sigma", "n", n);
            context__.validate_dims("data initialization", "Sigma", "matrix_d", context__.to_vec(n,n));
            Sigma = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(n, n);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(multi_normal_log<propto__>(u, mu, Sigma));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_bym2_covariance_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_bym2_covariance_namespace::model_bym2_covariance stan_model;
#ifndef USING_R
