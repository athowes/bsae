...
namespace model_bym2_centroid_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_bym2_centroid");
    ...
    reader.add_event(54, 4, "restart", "model_bym2_centroid");
    reader.add_event(115, 63, "end", "model_bym2_centroid");
    return reader;
}
...
class model_bym2_centroid
  : public stan::model::model_base_crtp<model_bym2_centroid> {
private:
        int n_obs;
        int n_mis;
        ...
        matrix_d D;
public:
    model_bym2_centroid(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bym2_centroid_namespace::model_bym2_centroid";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_bym2_centroid_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_bym2_centroid_namespace::model_bym2_centroid stan_model;
#ifndef USING_R
